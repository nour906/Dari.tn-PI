...
public class MailServiceImpl implements MailService {
	...
	public void sendWithAttachment(User user,Agent agent,String attachement) throws MailException, MessagingException {
		...
		buf.append("<html>\n" + "  <head>\n" + "    <meta name=\"viewport\" content=\"width=device-width\" />\n"
				...
				+ user.getFirst_name() + " from our client Mr" + 
						" " + user.getFirst_name() +" "+user.getLast_name()+ " and you find the attached simulation report </p>\n"
